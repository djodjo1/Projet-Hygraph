...
<template>
    <Container>
        ...
        <div v-if="produits" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div v-for="produit in produits" :key="produit.id">
                <div class="mb-9 block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                    <div class="relative overflow-hidden bg-cover bg-no-repeat">
                        <img class="rounded-t-lg w-full object-cover h-32 sm:h-40 lg:h-48" :src="produit.image.url" alt="" />
                    </div>
